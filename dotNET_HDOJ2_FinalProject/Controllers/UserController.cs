...
namespace dotNET_HDOJ2_FinalProject.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [DllImport(@"D:\HDOJ_dotNET\DLL\AES.dll", EntryPoint = "Encrypt", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = false)]
        public static extern int Encrypt(string str, ref byte res);
        [DllImport(@"D:\HDOJ_dotNET\DLL\AES.dll", EntryPoint = "GetMD5", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = false)]
        public static extern int GetMD5(string str, ref byte res);
        [DllImport(@"D:\HDOJ_dotNET\DLL\AES.dll", EntryPoint = "Decrypt", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, ExactSpelling = false)]
